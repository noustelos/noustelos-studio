...
const translations = {
  en: {
    ...
    about: {
      ...
      p4: "The two most recent ones approach the same idea from opposite ends. AskCarnivores.com is a bilingual directory of carnivore-diet creators, doctors and first-person accounts, where every link goes straight to the source and nothing is generated. AskCarnivore.com is the other door: a first-version switchboard that routes a question to the people who already answered it, returning talks and videos rather than an answer of its own. Both are live, and both are deliberately early — the directory's calculators and the bot's deeper index are still being built."
    },
    contact: {
  ...
  gr: {
    ...
    about: {
      ...
      p4: "Τα δύο πιο πρόσφατα πιάνουν την ίδια ιδέα από τις δύο άκρες. Το AskCarnivores.com είναι ένας δίγλωσσος κατάλογος δημιουργών, γιατρών και προσωπικών μαρτυριών για την carnivore διατροφή, όπου κάθε σύνδεσμος πάει κατευθείαν στην πηγή και τίποτα δεν παράγεται από AI. Το AskCarnivore.com είναι η άλλη πόρτα: ένα switchboard πρώτης έκδοσης που δρομολογεί μια ερώτηση σε όσους την έχουν ήδη απαντήσει, επιστρέφοντας ομιλίες και βίντεο αντί για δική του απάντηση. Και τα δύο είναι live, και τα δύο συνειδητά σε πρώιμο στάδιο — τα εργαλεία του καταλόγου και το βαθύτερο index του bot είναι ακόμα υπό κατασκευή."
    },
    contact: {
